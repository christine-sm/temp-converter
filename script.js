...
//F to C && F to K
//(F  -  32)  x  5/9 = C && (F + 459.67) × 5/9 = K
if (unit_start ==='F') {
  temp_array.push(parseInt(temp_start));
  console.log("Starting Temperature: " + temp_start + " F");
  temp_array.push((temp_start - 32) * (5/9));
  console.log("Converted to Celsius: " + (temp_start - 32) * (5/9) + " C");
  temp_array.push((temp_start + 459.67) * (5/9));
  console.log("Converted to Kelvin: " + ((temp_start + 459.67) * (5/9)) + " K");//Not converting to Kevlin properly
...
if (unit_start === 'C') {
    ((temp_start * (9/5)) + 32);
    console.log((temp_start * (9/5)) + 32 + " F");
}
...
if (unit_start === 'C') {
    (temp_start + 273.15);
    console.log(temp_start + 273.15 + " K");
}
...
if (unit_start === 'K') {
    ...
    console.log((temp_start * (9/5)) - 459.67 + " F");
}
...
if (unit_start === 'K') {
    (temp_start - 273.15);
    console.log(temp_start - 273.15 + " C");
}
